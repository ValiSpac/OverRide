```
   ...
   0x0804844c <+8>:	sub    $0x90,%esp - 144 bytes local v
   0x08048452 <+14>:	movl   $0x0,0x8c(%esp) - int v
   0x0804845d <+25>:	mov    0x80497f0,%eax
   0x08048462 <+30>:	mov    %eax,0x8(%esp)
   0x08048466 <+34>:	movl   $0x64,0x4(%esp)
   0x0804846e <+42>:	lea    0x28(%esp),%eax - buf = 144 - 4 - 40 = 100 bytes
   0x08048472 <+46>:	mov    %eax,(%esp)
   0x08048475 <+49>:	call   0x8048350 <fgets@plt>
   0x0804847a <+54>:	movl   $0x0,0x8c(%esp)
```
<14> - <54>: fgets(1, 100,buf );
```
   0x08048485 <+65>:	jmp    0x80484d3 <main+143> - start of loop
   0x08048487 <+67>:	lea    0x28(%esp),%eax - buf
   0x0804848b <+71>:	add    0x8c(%esp),%eax - buf + v
...
```
<103> - <133>: buf\[v] = buf \[v] ^ 32
```
   0x080484cb <+135>:	addl   $0x1,0x8c(%esp) v++
